...
//               ✅ Backend connection successful! Found {users.length} users in the
//               system.
//             </div>
//           )}
...
//             <button
//               onClick={() =>
//                 window.open("http://localhost:5000/api/users/", "_blank")
//               }
...
//             <button
//               onClick={() =>
//                 window.open("http://localhost:5000/api/storage-nodes/", "_blank")
//               }
...
//             <button
//               onClick={() =>
//                 window.open("http://localhost:5000/api/uploads", "_blank")
//               }
