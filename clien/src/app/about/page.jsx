...
const About = () => {
  ...
  const team = [
    { name: "Mercy Kinya", role: "Project Manager", background: "Emerging Leader", focus: "Strategic Vision" },
  ...
  return (
    <div className="about-root">
      ...
      <section className="mission-vision">
        ...
        {/* ✅ Updated Impact Stats: two columns */}
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }}>
